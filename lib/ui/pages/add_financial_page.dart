...
import 'package:walletwise_app/shared/snackbar.dart';
import 'package:walletwise_app/shared/theme.dart';
import 'package:walletwise_app/ui/widgets/buttons.dart';
import 'package:walletwise_app/ui/widgets/forms.dart';
...
class _AddFinancialPageState extends State<AddFinancialPage> {
  ...
  void save(BuildContext context, String tanggal, String kategori,
      String tipeTransaksi, int jumlah, String catatan) async {
    ...
    String transactionString = prefs.getString('catatan_key') ?? '';
    List<Catatan> transactions = Catatan.decode(transactionString);

    transactions.add(newTransaction);

    String updatedTransactionsString = Catatan.encode(transactions);
    await prefs.setString('catatan_key', updatedTransactionsString);
